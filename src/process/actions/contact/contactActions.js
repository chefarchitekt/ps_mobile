...
import {
    ...
    //kazoo contact list (list->account/users)
    GET_ACTIVE_USER_SUCCESS,
    GET_TEAM_CONTACTS_SUCCESS,
    SET_TEAM_CONTACTS,
    EMPTY_TEAM_CONTACTS,

    //detail team contacts
    GET_TEAM_MEMBERS_DETAIL_SUCCESS,
    SET_TEAM_MEMBERS_DETAIL,
...
export const getActiveContact = (dispatch, selectedUserId, userSessionData) => {
    ...
    const memberToSeek = { 
        ...
        successFunc: (response) => {
            const userObject = {
                ...
                onlineStatus: response.data.status,
